...
def seg_unet_reg_v1_generator(block_fn, layers, num_classes, data_format='channels_last'):
...
def seg_unet_reg_v1(unet_size, num_classes, data_format=None):
    ...
    return seg_unet_reg_v1_generator(params['block'], params['layers'], num_classes, data_format)
